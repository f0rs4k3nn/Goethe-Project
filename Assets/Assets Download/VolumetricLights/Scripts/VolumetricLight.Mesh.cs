        ...
        bool CheckMesh() {
            ...
            switch (lightComp.type) {
                ...
                case LightType.Point:
                    ...
                    break;
                case LightType.Area:
                    if (needMesh || generatedType != LightType.Area || customRange != generatedRange || areaWidth != generatedAreaWidth || areaHeight != generatedAreaHeight || (profile != null && profile.frustumAngle != generatedAreaFrustumAngle)) {
                        GenerateCubeMesh();
                        return true;
                    }
                    break;
                case LightType.Disc:
                    if (needMesh || generatedType != LightType.Disc || customRange != generatedRange || areaWidth != generatedAreaWidth || (profile != null && profile.frustumAngle != generatedAreaFrustumAngle)) {
